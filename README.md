...
一个用于 AI 智能体的技能，辅助用户根据课程论文模板准备 Word 文档。支持 Claude Code、Trae、Codex 等多个平台。
...
├── assets/
│   └── templates/
│       └── buaa-course-paper-template.docx  # 课程论文模板
└── evals/
    └── evals.json                        # 测试用例
```
...
| `buaa-course-paper-template.docx` | 课程论文模板 | 包含封面表格、段落样式、Logo |
...
1. 安装技能到你的 AI 智能体
2. 重启智能体
3. 输入：`/buaa-final-assignment` 或 `帮我做课程论文`
4. 按提示输入课程信息、姓名、学号等
5. AI 会生成草稿供你审核修改
